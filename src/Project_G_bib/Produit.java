...
public class Produit extends javax.swing.JFrame {
    ...
    public Produit() {
     ...
     public void table() {
        String t[] = {"id","code_produit","nom","categorie","reference","fournisseur","remise","prix","quantite"};
    ...
    private void initComponents() {
        ...
        tbl_prod.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "code_produit", "reference", "Categorie", "Nom produit", "fournisseur", "remise", "prix", "Quantité"
            }
        ) {
        ...
        jScrollPane1.setBounds(0, 120, 1040, 150);
        ...
        jButton3.setBounds(130, 300, 130, 40);
        ...
        jButton4.setBounds(260, 300, 170, 40);
        ...
        jPanel1.add(jPanel2);
        jPanel2.setBounds(10, 370, 580, 190);
        ...
        comrech.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "id", "nom", "categorie", "Reference", "fournisseur", "remise", "prix", "Quantité" }));
        ...
        jPanel3.add(comrech);
        comrech.setBounds(90, 60, 150, 40);
        ...
        jPanel3.add(txtrech);
        txtrech.setBounds(140, 140, 230, 40);

        jPanel1.add(jPanel3);
        jPanel3.setBounds(600, 270, 430, 290);
        ...
        jButton5.setBounds(430, 300, 170, 40);
        ...
        jToolBar1.setBounds(420, 140, 100, 25);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (txtid.getText().equals("") || txtref.getText().equals("") || txtdes.getText().equals("")
            ...
            String[] colon = {"code_produit","nom","categorie","reference","fournisseur","remise","prix","quantite"};
...
if (txtrech.getText().equals("")) {
            ...
            if (comrech.getSelectedItem().equals("code_produit")) {
                ...
                rs = db.querySelectAll("produit", "nom LIKE '%" + txtrech.getText() + "%' ");
                tbl_prod.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("categorie")) {
                ...
                tbl_prod.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("quantite")) {
                rs = db.querySelectAll("produit", "quantite LIKE '%" + txtrech.getText() + "%' ");
                tbl_prod.setModel(new ResultSetTableModel(rs));
