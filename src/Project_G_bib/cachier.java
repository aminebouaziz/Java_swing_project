...
public class cachier extends javax.swing.JFrame {
    ...
    public void importer() {
        String colon[] = {"num_facture","code_produit","nom","prix_vente","stock_sortie","subtotal"};
    ...
    private void initComponents() {
        ...
        jButton3.setBounds(310, 120, 120, 33);
        ...
        jButton4.setBounds(440, 120, 110, 33);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (txtrech.getText().equals("")) {
            ...
            if (comrech.getSelectedItem().equals("code_produit")) {
                String colon[] = {"code_produit","nom","categorie","reference","fournisseur","remise","prix","quantité"};
                rs = db.fcSelectCommand(colon, "produit", "code_produit LIKE '" + txtrech.getText() + "' ");
                tbl_res.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("nom")) {
                String colon[] = {"code_produit","nom","categorie","reference","fournisseur","remise","prix","quantité"};
                rs = db.fcSelectCommand(colon, "produit", "nom LIKE '" + txtrech.getText() + "' ");
                tbl_res.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("categorie")) {
                String colon[] = {"code_produit","nom","categorie","reference","fournisseur","remise","prix","quantité"};
                rs = db.fcSelectCommand(colon, "produit", "categorie LIKE '" + txtrech.getText() + "' ");
                tbl_res.setModel(new ResultSetTableModel(rs));
                ...
                String colon[] = {"code_produit","nom","categorie","reference","fournisseur","remise","prix","quantité"};
                rs = db.fcSelectCommand(colon, "produit", "quantité LIKE '" + txtrech.getText() + "' ");
                tbl_res.setModel(new ResultSetTableModel(rs));
